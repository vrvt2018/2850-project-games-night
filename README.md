...
3. View the H2 data directly using your IDE's Database tool or the native H2 Console by connecting to JDBC URL `jdbc:h2:./build/db/games-night;MODE=PostgreSQL`.
